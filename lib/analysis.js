...
function dealRowValue(row) {
  const v = row.fieldValue ?? row.field_value ?? row.value ?? row.custom_field_text_value
    ?? row.custom_field_number_value ?? row.custom_field_date_value ?? row.custom_field_currency_value;
